            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container px-4">
                        <h1 class="mt-4 d-flex justify-content-center">Accueil</h1>
                        <ol class="breadcrumb mb-4">
                        </ol>
                        <div class="row d-flex justify-content-center">
                            <div class="col-xl-6 col-md-6">
                                <div class="card text-white mb-4 p-3 text-center">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                    <div class="card-body">Produit/Stock</div>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="card text-white mb-4 p-3 text-center">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                    <div class="card-body">Fournisseurs</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">Voir plus</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                         ...
                         <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="card text-white mb-4 p-3 text-center">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                    <div class="card-body">Achats</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">Voir plus</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                         ...
                         <div class="row d-flex justify-content-center">
                            <div class="col-xl-6 col-md-6">
                                <div class="card text-white mb-4 p-3 text-center">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                    <div class="card-body">Facturations</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">Voir plus</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="card text-white mb-4 p-3 text-center">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                    <div class="card-body">Parametrage</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">Voir plus</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
