                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <a href="#addEmployeeModal" class="btn btn-success mt-3 mb-3" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Ajouter un client</span></a>
                                </div>
                                 <div class="col-3">
                                    <a href="#deleteEmployeeModal" class="btn btn-danger  mt-3" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Supprimer</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="clearfix">
                            ...
                            <ul class="pagination">
                                <li class="page-item disabled"><a href="#">Precedente</a></li>
                                <li class="page-item"><a href="#" class="page-link">1</a></li>
                                <li class="page-item"><a href="#" class="page-link">2</a></li>
                                <li class="page-item active"><a href="#" class="page-link">3</a></li>
                                <li class="page-item"><a href="#" class="page-link">4</a></li>
                                <li class="page-item"><a href="#" class="page-link">5</a></li>
                                <li class="page-item"><a href="#" class="page-link">Prochaine</a></li>
                            </ul>
                        </div>
                    </div>
                </div>        
